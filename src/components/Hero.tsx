        ...
        <div className="animate-in fade-in duration-1000">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className={`text-center p-6 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-500 transform hover:scale-110 hover:-translate-y-2 animate-in slide-in-from-bottom duration-1000 ${
